...
class tcw_venator_full : ls_staticShip_venator {
      scope = 2;
      scopeCurator = 2;

      displayName = "[TCW] The Retribution (Full Closed)";
      editorCategory = "tcw_assets";
      editorSubcategory ="tcw_ships";
      multistructureparts[] =
      {
            {"tcw_ven_body1_1","body1_1"},
            {"tcw_ven_body1_2","body1_2"},
            {"tcw_ven_body2_1","body2_1"},
            {"tcw_ven_body2_2","body2_2"},
            {"tcw_ven_body2_3","body2_3"},
            {"tcw_ven_body3","body3"},
            {"tcw_ven_body4","body4"},
            {"tcw_ven_body5","body5"},
            {"tcw_ven_body6","body6"},
            ...
            {"tcw_ven_body8","body8"},
            {"tcw_ven_body9","body9"},
            {"tcw_ven_body10","body10"},
            {"tcw_ven_door","door"},
            {"tcw_ven_engine","engine"},
            {"tcw_ven_int1","interior1"},
            {"tcw_ven_int2","interior2"},
            {"tcw_ven_int3","interior3"},
            {"tcw_ven_int4","interior4"},
            {"tcw_ven_int5","interior5"},
            {"tcw_ven_int6","interior6"},
            {"tcw_ven_int7","interior7"},
            {"tcw_ven_int8","interior8"},
            {"tcw_ven_bridge","bridge"}
      };
};

class ls_staticShip_venator_open;
class tcw_venator_full_open : ls_staticShip_venator_open {
      scope = 2;
      scopeCurator = 2;

      displayName = "[TCW] The Retribution (Full Open)";
      editorCategory = "tcw_assets";
      editorSubcategory ="tcw_ships";
      multistructureparts[] =
      {
...
class tcw_venator_full_hollow : ls_staticShip_venator_fullHollow {
      scope = 2;
      scopeCurator = 2;

      displayName = "[TCW] The Retribution (Full Hollow)";
      editorCategory = "tcw_assets";
      editorSubcategory ="tcw_ships";
      multistructureparts[] =
      {
...
class tcw_venator_open_full_hollow : ls_staticShip_venator_open_fullHollow {
      scope = 2;
      scopeCurator = 2;

      displayName = "[TCW] The Retribution (Qpen Full Hollow)";
      editorCategory = "tcw_assets";
      editorSubcategory ="tcw_ships";
      multistructureparts[] =
      {
...
class tcw_ven_body1_1 : ls_staticShipPart_venator_body1_1 {
      scope = 2;
      scopeCurator = 2;
