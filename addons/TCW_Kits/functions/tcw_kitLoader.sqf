...
[
    ...
    [["tcw_dc15a","","","",["tcw_dc15a_mag",30],[],""],[],["tcw_dc17","","","",["tcw_dc17_mag",50],[],""],["tcw_clone_uniform",[["ACE_tourniquet",2],["tcw_dc15a_mag",6,30]]],["tcw_vest_plate_base",[["ACE_elasticBandage",15],["ACE_packingBandage",15],["ACE_epinephrine",4],["ACE_morphine",1],["ACE_tourniquet",2],["ACE_splint",4],["ACE_plasmaIV_250",1],["ACE_CableTie",2],["ACE_Flashlight_XL50",1],["ACE_EntrenchingTool",1],["acc_flashlight",1],["tcw_dc15a_mag",8,30],["tcw_dc17_mag",3,50],["tcw_stun_mag_long",2,5],["Laserbatteries",1,1],["ACE_painkillers",1,10],["tcw_ThermalDetonator",3,1],["tcw_SmokeWhite",3,1],["tcw_SonicDetonator",2,1]]],["tcw_clone_backpack",[]],"tcw_p1_helmet_base","",["IDA_Electrobinoculars_Rep","","","",["Laserbatteries",1],[],""],["ItemMap","ItemGPS","ls_radios_cwp8","ItemCompass","ItemWatch",""]], //Main Gear in kit
