...
private _altGearHeavy = ["k_cadet_Helmet","tcw_clone_uniform","tcw_clone_backpack","tcw_z6","tcw_z6_mag","tcw_SmokeWhite","ACE_tourniquet","ACE_plasmaIV_250","ACE_packingBandage","tcw_dc15le","tcw_dc15le_mag"];
