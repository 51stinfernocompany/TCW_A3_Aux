...
[
    TCW_KitBoxCadet,
    "Marksman",
    [["tcw_dc15x","","","",["tcw_dc15x_magazine",13],[],""],[],["tcw_dc17","","","",["tcw_dc17_mag",50],[],""],["tcw_clone_uniform",[["ACE_CableTie",4],["ItemcTabHCam",1],["ACE_IR_Strobe_Item",1],["TCW_tourniquet",4],["TCW_splint",4],["TCW_bactaSpray",30],["TCW_adrenalStim",1],["TCW_combatStim",1],["tcw_SmokeWhite",2,1]]],["tcw_vest_plate_base",[["ACE_EntrenchingTool",1],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["WBK_HeadLampItem_Narrow",1],["tcw_dc17_mag",2,50],["tcw_dc15x_magazine",15,20],["3AS_SmokeWhite",3,1],["tcw_SonicDetonator",2,1],["Laserbatteries",1,1],["ACE_painkillers",1,10]]],["tcw_clone_backpack",[]],"k_cadet_Helmet","",["IDA_Electrobinoculars_Rep","","","",["Laserbatteries",1],[],""],["ItemMap","ItemGPS","ls_radios_cwp8","ItemCompass","ItemWatch",""]],
    _altGearMarksman,
