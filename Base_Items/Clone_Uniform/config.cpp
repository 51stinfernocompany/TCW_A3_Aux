...
class CfgVehicles
{
	...
	class TCW_Base_Uniform_IDA_Veh: IDA_Clone_DC15S
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"\Indecisive_Armoury_Units\REPUBLIC\Clone_Uniform\Upper\IDA_BodyUpper_co.paa",	//Top
			"\Indecisive_Armoury_Units\REPUBLIC\Clone_Uniform\Lower\IDA_BodyLower_co.paa",	//Bottom
		};
		class HitPoints: HitPoints
		{
			class HitFace
